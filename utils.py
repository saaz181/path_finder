...
if __name__ == '__main__':
    ...
    if default_input == 'N':
        ...
        Main_matrix = copy.deepcopy(d_matrix)
        ...
        board_row_size_bfs = board_row_size_dfs = board_row_size_ids = board_row_size_ucs = board_row_size_astar = board_row_size_best_first_search = row_size
        board_col_size_bfs = board_col_size_dfs = board_col_size_ids = board_col_size_ucs = board_col_size_astar = board_col_size_best_first_search = col_size
